...
export class Bootstrap {
    ...
    private setupApplication() {
      ...
      const clientBuildRoot = path.join(root, 'build/client');
      const isomorphicBuildRoot = path.join(root, 'build/isomorphic');
      ...
      if (process.env.NODE_ENV === 'development') {
        ...
        const isomorphicRoot = path.join(root, 'isomorphic');
